...
const CustomCheckbox: React.FC<CustomCheckboxProps> = ({ checked, label, onChange  }) => {
  const checkboxClass = checked
    ? 'border-violet-600 bg-[#6C69B1]' 
    : 'border-gray-300'; 

  return (
    <label className="mt-2.5 flex items-center gap-3 p-2.5 border bg-gray-50 rounded-lg cursor-pointer transition-colors">
      <div
